...
namespace til {
  ...
  public:
    ...
    function_call_node(int lineno, const std::string &identifier) :
        cdk::expression_node(lineno), _identifier(identifier), _parameters(new cdk::sequence_node(lineno)) {
    }
    ...
    function_call_node(int lineno, const std::string &identifier, cdk::sequence_node *arguments) :
        cdk::expression_node(lineno), _identifier(identifier), _parameters(arguments) {
    }
  ...
  public:
    ...
    cdk::expression_node *argument(size_t ix) {
      return dynamic_cast<cdk::expression_node*>(_parameters->node(ix));
    }
